...
public class OLSCommandLineParser implements CommandLineParserUtil {
	...
	public OLSCommandLineParser(String [] args) throws ParseException {
		...
		options.addOption( "respcolnme", "response_column_name",    true, 
				"If labels are not in first column, this option gives the name of the response column." );
		options.addOption( "respcolno", "response_column_no",    true, 
				"If labels are not in first column, this option gives the index of the response column." );
